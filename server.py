...
#  Now with real Twitch OAuth login!
# ============================================================
...
def auth_twitch():
    """
    Step 1 — Send user to Twitch login page.
    Twitch will ask them to approve PogClip's access.
    """
...
def auth_twitch_callback():
    """
    Step 2 — Twitch sends user back here after they approve.
    We exchange the code for a real access token.
    """
    ...
    # Use the token to get the user's Twitch info
    ...
    # If user is logged in — connect Twitch to their existing account
    if current_user.is_authenticated:
    ...
    # If not logged in — check if Twitch account already exists
    ...
    # Brand new user via Twitch — create account automatically
    ...
    # Use Twitch email or generate placeholder
...
# ============================================================
#  API ROUTES — used by desktop app
# ============================================================
